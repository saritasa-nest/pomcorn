...
(see [Locators](locators.md)), which will be used to search for this component in its waiting
...
!!! note
    ...
    element-attributes (see [descriptors](descriptors.md)), and within **Page** and **Component**
    classes, an element can be defined using the [self.init_element](developer_interface.md#webview) method.
