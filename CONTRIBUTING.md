...
Report bugs at
<https://github.com/saritasa-nest/pomcorn/issues>.
...
`pomcorn` could always use more documentation,
whether as part of the official `pomcorn` docs,
...
Ready to contribute? Here's how to set up `pomcorn`
for local development.

Fork the [pomcorn](https://github.com/saritasa-nest/pomcorn) repo on GitHub.
And then clone your fork locally:

```bash
git clone git@github.com:your_name_here/pomcorn.git
```
